...
const Events = () =>
{
    ...
    return (
        ...
        <div className="    ">
            ...
            <div className='container mx-auto px-8 py-12' id="eventpreview">

                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-20 border-b border-slate-200 ">
                    ...
                    <div className="flex-1 lg:text-right">
                        <p className="text-slate-500 max-w-lg lg:ml-auto text-xs md:text-base leading-relaxed tracking-wide font-light">
                            ...
                            <div className="absolute inset-0 p-8 md:p-10 flex flex-col justify-end z-10">
                                ...
                                <div className="mt-7 pt-5 border-t border-white/10 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2 text-white/40">
                                        ...
                                        <span className="text-[8px] md:text-[10px] uppercase tracking-[0.25em]">
                                            {item.date}
                                        </span>
                                    </div>
                                    ...
                                    <Link
                                        to={`/events/${item.id}`}
                                        className="group/btn flex items-center gap-2 px-3 md:px-5 py-1 md:py-2.5 bg-white text-[#0b2a30] rounded-[4px] text-[8px] md:text-[10px] font-bold uppercase tracking-[0.25em] hover:bg-red-800 hover:text-white transition-all duration-500"
                                    >
                                        Explore
                                        <ArrowRight
                                            size={14}
