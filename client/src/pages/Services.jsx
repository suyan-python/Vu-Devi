  ...
  const services = [
    {
      ...
      icon: <FaFileMedical className="text-red-900 text-5xl mx-auto mb-4" />,
    },
    {
      ...
      icon: <FaClipboardList className="text-red-900 text-5xl mx-auto mb-4" />,
    },
    {
      ...
      icon: <FaKeyboard className="text-red-900 text-5xl mx-auto mb-4" />,
    },
    {
    ...
    },
    {
      ...
      icon: <FaUserMd className="text-red-900 text-5xl mx-auto mb-4" />,
    },
  ];
  ...
  return (
    <section className="w-full py-16 ">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <motion.h2
          className="header text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-12 text-red-700"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              {service.icon}
              <h3 className="text-xl sm:text-2xl font-semibold text-red-900 mb-3">
                {service.title}
              </h3>
