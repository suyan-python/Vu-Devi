  ...
  const services = [
    {
      ...
      icon: <FaFileMedical className="text-blue-500 text-5xl mx-auto mb-4" />,
    },
    {
      title: "Data Processing",
      description:
        "Efficient data handling and analytics for healthcare institutions.",
      icon: <FaDatabase className="text-blue-500 text-5xl mx-auto mb-4" />,
    },
    {
      title: "Healthcare Support",
      description:
        "End-to-end backend support ensuring seamless healthcare operations.",
      icon: <FaHeadset className="text-blue-500 text-5xl mx-auto mb-4" />,
    },
    {
      title: "Medical Consultation",
      description:
        "Expert medical advice from certified professionals to ensure quality care.",
      icon: <FaUserMd className="text-blue-500 text-5xl mx-auto mb-4" />,
    },
    {
      title: "Healthcare Analytics",
      description:
        "AI-driven insights and reports to optimize healthcare decision-making.",
      icon: <FaChartBar className="text-blue-500 text-5xl mx-auto mb-4" />,
    },
    {
      ...
      icon: (
        <FaClipboardCheck className="text-blue-500 text-5xl mx-auto mb-4" />
      ),
    },
  ];
