      ...
      >
        <div className="bg-white rounded-sm  border border-slate-200 overflow-hidden">
          ...
          <div className="bg-slate-900 p-8 text-center relative space-y-2">
            ...
            <h1 className="text-white text-xl font-bold tracking-[0.1em] ">
              Vu Devi Services
            </h1>
            <h1 className="text-white text-xs font-bold tracking-[0.2em] uppercase">
              Administrative <span className="text-red-500">Portal</span>
            </h1>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="group">
                ...
                <div className="relative">
                  <User
                    className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#133a41] transition-colors"
                    size={18}
                  />
                  <input
                    type="text"
